# -*- coding: utf-8 -*-
"""emotionsDetectionProject.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zHTpXVQMOCOlcJIq2P9ID6KBBiGQXTp-
...
class ITrainable():
  ...
  def save_parameters():
    raise NotImplementedError("save_parameters not implemented: ITrainable is an interface")
  def load_parameters():
    raise NotImplementedError("load_parameters not implemented: ITrainable is an interface")
...
# prompt: make activation class that his init function takes string "activation" that would detemine witch activation should it use, include this activations:
# tanh,sigmoid,softmax,relu
